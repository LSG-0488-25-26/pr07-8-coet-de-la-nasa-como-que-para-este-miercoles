...
fun UmamusumeDetail.toFavourite(): Favourite {
    return Favourite(
        ...
        earsFact = this.earsFact,
        tailFact = this.tailFact,
        ...
        enCategoryLabel = this.enCategoryLabel,
        categoryValue = this.categoryValue,
        snsHeader = this.snsHeader,
        snsIcon = this.snsIcon,
        familyFact = this.familyFact,
        gameId = this.gameId,
        link = this.link,
        preferredUrl = this.preferredUrl,
        detailImgPc = this.detailImgPc,
        detailImgSp = this.detailImgSp,
        ...
        internalName = this.nameInternal
    )
}